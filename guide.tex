...
\begin{tipbox}
我当时的做法：预答辩时录了音（征得同意），回去后对着录音逐条整理，避免遗漏。答辩人普遍反馈这份整理比他们自己记的要全得多。
\end{tipbox}
...
\begin{tabular}{@{}ll@{}}
\toprule
\textbf{表决项} & \textbf{格式参考} \\
\midrule
论文答辩         & 同意 / 不同意，\important{另附具体意见} \\
是否建议授予学位 & 建议 / 不建议 \\
\bottomrule
\end{tabular}
\end{table}
...
\begin{warnbox}
表决结果为\textbf{同意票$\geq 2/3$}通过。统计完成后请主席在表决结果上签字确认。
\end{warnbox}
