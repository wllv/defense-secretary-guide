...
\pagestyle{fancy}
\fancyhf{}
\fancyhead[L]{\small\color{gray}答辩秘书经验指南}
...
{\Huge\bfseries\color{lzublue}答辩秘书经验指南}
...
通知发送时同步附上日程表文件。除微信群公告外，还须给团队内的老师逐一发通知。
...
答辩委员会名单由答辩人导师确定后告知答辩秘书。秘书无需自行组建。导师告知名单时，秘书应同时提醒导师是否需要为答辩委员安排住宿。
